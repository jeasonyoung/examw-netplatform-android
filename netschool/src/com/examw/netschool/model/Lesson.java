...
public class Lesson implements Serializable,Comparable<Lesson> {
	...
	public String getPriorityUrl(){
		//标清视频URL
		if(StringUtils.isNotBlank(this.getVideoUrl())) return this.getVideoUrl();
		//高清视频URL
		if(StringUtils.isNotBlank(this.getHighVideoUrl())) return this.getHighVideoUrl();
		//超清视频URL
		if(StringUtils.isNotBlank(this.getSuperVideoUrl())) return this.getSuperVideoUrl();
		//没有视频
		return null;
	}
	/**
