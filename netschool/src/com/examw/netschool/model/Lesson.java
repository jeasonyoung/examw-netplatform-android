...
//	private Integer time,orderNo;
	...
	public String getPriorityUrl(){
		//标清视频URL
		if(StringUtils.isNotBlank(this.video_url)) return this.video_url;
		//高清视频URL
		if(StringUtils.isNotBlank(this.high_video_url)) return this.high_video_url;
		//超清视频URL
		if(StringUtils.isNotBlank(this.super_video_url)) return this.super_video_url;
		//没有视频
		return null;
	}
	/**
