...
public class AppConfig {
	...
	public final static String TMEP_TWEET_TITLE = "temp_tweet_title";
	public final static String TEMP_TWEET_IMAGE = "temp_tweet_image";
	public final static String TEMP_REPLY_IMAGE = "temp_reply_image";
	...
	@SuppressLint("NewApi")
	public final static String DEFAULT_SAVE_IMAGE_PATH = Environment.getExternalStorageDirectory()+ File.separator+ "Eschool"+ File.separator+"images"+File.separator;
...
//	private AccessInfo accessInfo = null;
	...
	public float getExamFontSize()
	{
		return StringUtils.toFloat(get(CONT_EXAM_FONT_SIZE));
	}
	public void setExamFontSize(float size)
	{
		set(CONT_EXAM_FONT_SIZE,String.valueOf(size));
	}
